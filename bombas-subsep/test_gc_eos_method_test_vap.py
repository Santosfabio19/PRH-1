...
stream_S01 = gc_eos_class(mixture, 97.3747857231822+273.15, 22503.6470366682, None, 2, -1, Aij, volumn_desviation, 'liquid')
...
solver_stream_vap.build_phase_envelope([0,150],150,[1e3,2.2e4],2.1e4,10,500)
