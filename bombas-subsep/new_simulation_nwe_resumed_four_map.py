...
stream_nwe_2 = gc_eos_class(mixture_nwe_2, 97.29+273.15, 1.4e4, None, 2, -1, Aij, volumn_desviation, 'liquid')
...
stream_nwe_33 = gc_eos_class(mixture_nwe_3, 80+273.15, 1.55e4, None, 2, -1, Aij, volumn_desviation, 'liquid')
stream_nwe_34 = gc_eos_class(mixture_nwe_3, 100+273.15, 1.55e4, None, 2, -1, Aij, volumn_desviation, 'liquid')
stream_nwe_35 = gc_eos_class(mixture_nwe_3, 80+273.15, 1.8e4, None, 2, -1, Aij, volumn_desviation, 'liquid')
stream_nwe_36 = gc_eos_class(mixture_nwe_3, 100+273.15, 1.8e4, None, 2, -1, Aij, volumn_desviation, 'liquid')
...
vap_refresh_3 = stream_nwe_3_vap3.copy_change_conditions(40+273.15, 1.55e4, None, 'gas')
vap_refresh_4 = stream_nwe_3_vap4.copy_change_conditions(40+273.15, 1.55e4, None, 'gas')
vap_refresh_5 = stream_nwe_3_vap5.copy_change_conditions(40+273.15, 1.8e4, None, 'gas')
vap_refresh_6 = stream_nwe_3_vap6.copy_change_conditions(40+273.15, 1.8e4, None, 'gas')
...
N = [200,300,400,500,600, 700] # ,400,500,600,700]
...
for i,vap in enumerate(list_vap):
    ...
    c = compression(vap, compressor, vis_case)
    c.characterization(N,0.5)
    list_map.append(c)
...
for i,vap in enumerate(list_vap):
    compressor = CompressorClass()
    vis_case = viscosity(vap.mixture, [0]*19)        
    c = compression(vap, compressor, vis_case, compressible=False)
    c.characterization(N,0.5)
