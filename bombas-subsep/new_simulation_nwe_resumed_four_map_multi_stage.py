...
stream_nwe_1 = gc_eos_class(mixture_nwe_1, 97.29+273.15, 1.4e4, None, 2, -1, Aij, Bij, Cij, volumn_desviation, 'liquid')

stream_nwe_2 = gc_eos_class(mixture_nwe_2, 97.29+273.15, 1.4e4, None, 2, -1, Aij, Bij, Cij, volumn_desviation, 'liquid')
...
for i,vap in enumerate([list_vap[2],list_vap[3]]):
