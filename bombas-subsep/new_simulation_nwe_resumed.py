...
stream_nwe_3 = gc_eos_class(mixture_nwe_3, 85+273.15, 1.4e4, None, 2, -1, Aij, volumn_desviation, 'liquid')
...
phi, stream_nwe_3_vap, liq = solver_stream_nwe_3.evaluate_flash(stream_nwe_3, y0, x0)

solver_stream_nwe_3_vap = solver_eos(stream_nwe_3_vap)
...
solver_stream_nwe_3.critical_init_value = [800, 0.15]

solver_stream_nwe_3.build_phase_envelope([50,250],240,[1e3,1.6e4],2.3e4,5,500)

solver_stream_nwe_3.plot_envelope()

# solver_stream_nwe_3_vap.set_estimated_conditions(x0, y0, w0)
# solver_stream_nwe_3_vap.isochoric_evaluation = False
# solver_stream_nwe_3_vap.critical_evaluation = True
# solver_stream_nwe_3_vap.water_evaluation = False
# solver_stream_nwe_3_vap.step_flash = 10
# solver_stream_nwe_3_vap.critical_init_value = [800, 0.15]

# solver_stream_nwe_3_vap.build_phase_envelope([15,100],100,[1e3,1.2e4],1.2e4,5,500)

# solver_stream_nwe_3_vap.plot_envelope()
