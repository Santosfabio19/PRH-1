...
Aij = [[Aij[i][j]*0 for i in range(len(Aij)) if i > 0] for j in range(len(Aij)) if j > 0]
...
for P in range(10000,278270,1000):
    
    soma, y1, vap, liq = pinit.test_bubble_T(250+273.15, P, y0)
